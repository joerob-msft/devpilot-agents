...
$contract = [ordered]@{
    ...
    description    = ('The base identities a sealed reviewer fixture may be bound to. A superseded identity is ' +
        'accepted only through an equal-tree active lineage. A main-parent squash may carry that lineage through ' +
        'the verifier-pinned exact PR117 source carrier plus the contract-bound reviewer artifacts. Regenerate ' +
        'with tools/New-ReviewerBaseContract.ps1.')
